  ...
  return (
    <div className="h-[calc(100dvh-7rem)] md:h-[calc(100dvh-8rem)] flex flex-col gap-6 pb-20 md:pb-6 animate-fade-in">
      ...
      <div className="flex flex-col lg:flex-row gap-6 h-full min-h-0">
          {/* Employee List - Fixed height on mobile to prevent full page scroll take over */}
          <div className="w-full lg:w-1/3 bg-white rounded-2xl shadow-sm border border-slate-100 flex flex-col overflow-hidden flex-none h-48 lg:h-auto shrink-0">
